...
export default function App() {
    ...
    if (!intel) {
      ...
      try {
        intel = await withRetry(
          () => callClaude([{ role: "user", content: researchPrompt }], [{ type: "web_search_20250305", name: "web_search" }], 2000),
          2
        );
  ...
  return (
    <div style={{ ...body, background: t.paper, backgroundImage: t.atmo, backgroundAttachment: "fixed", color: t.ink, minHeight: "100vh", colorScheme: mode, WebkitFontSmoothing: "antialiased" }}>
      <style>{`
        @media print {
...
function SwotCard({ t, tone, label, items }) {
  ...
  return (
    <div className="p-4" style={{ border: `1px solid ${t.hair}`, background: t.card, borderRadius: 16, borderLeft: `4px solid ${accent}`, boxShadow: t.shadowSoft }}>
