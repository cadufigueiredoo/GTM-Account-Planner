        ...
        {hasPlan && (
          <article className="mt-8">
            ...
            <div className="no-print mt-8 flex gap-3">
              <button onClick={() => window.print()} className="px-5 py-3 font-semibold" style={{ background: mode === "light" ? t.forest : t.bright, color: mode === "light" ? "#fff" : t.forest, cursor: "pointer", border: "none", borderRadius: 14, fontSize: 17 }}>
                Exportar / imprimir
              </button>
            </div>
